...
> **Статус:** `evergreen` • **Уровень:** `базовый` • **Для:** аналитиков, разработчиков
>
> Полное руководство по созданию качественных REST/gRPC API с использованием Context7 для актуальной документации
...
| Дата | Изменение |
|------|-----------|
| 2026-06 | Добавлены метаданные, learning path, ченжлог; усилены cross-refs |
...
- [`api-openapi-template.yaml`](./api-openapi-template.yaml) — шаблон для OpenAPI 3.0.1
- [`api-swagger-template.yaml`](./api-swagger-template.yaml) — шаблон для Swagger 2.0

---

## 🔗 Связанные разделы

- [Database — моделирование БД](../Database/README.md) — схемы данных для API
- [Structurizr — C4-диаграммы архитектуры](../Structurizr/README.md) — контекст и контейнеры
- [Sequence Plant UML — диаграммы последовательности](../Sequence%20Plant%20UML/README.md) — визуализация API-сценариев
- [Temporal — оркестрация workflow](../temporal/README.md) — долгоживущие API-процессы
- [Гайд MCP — Context7 для API](../Instructions/Гайд%20MCP.md) — настройка AI-агентов

...
```powershell
Set-Location C:\Users\user\Desktop\GIT\Handy; bun run tauri dev
```
...
```powershell
$env:Path = "$env:Path;C:\Users\user\.rustup\toolchains\stable-x86_64-pc-windows-msvc\bin"
$env:Path = "$env:Path;C:\Users\user\.cargo\bin"
...
```powershell
cd C:\Users\user\Desktop\GIT\Handy
...
```powershell
$env:Path = "$env:Path;C:\Users\user\.cargo\bin;C:\Program Files\CMake\bin"; $env:LIBCLANG_PATH = "C:\Program Files\LLVM\bin"; $env:VULKAN_SDK = "C:\VulkanSDK\1.4.341.1"; $env:WEBKIT_DISABLE_COMPOSITING_MODE = "1"; Set-Location C:\Users\user\Desktop\GIT\Handy; bun run tauri dev
```
...
| **Путь** | `C:\Users\user\AppData\Roaming\com.pais.handy\models\ggml-large-v3-q5_0.bin` |
...
| **Формат** | CTranslate2 |
| **Путь** | `C:\Users\user\.cache\huggingface\hub\models--Systran--faster-whisper-large-v3` |
...
| Путь | Назначение |
|------|------------|
| `C:\Users\user\AppData\Roaming\com.pais.handy\history.db` | История транскрипций (SQLite) |
| `C:\Users\user\Desktop\GIT\Handy\src-tauri\resources\models\` | Папка с моделями (VAD, Whisper) |
| `C:\Users\user\Desktop\GIT\Handy\src-tauri\target\` | Результаты сборки |

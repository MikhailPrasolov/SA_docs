...
Кастомные агенты для Kilo Code — расширенная система оркестрации на базе OpenAgentsControl. Включает primary-агентов с делегированием, 20 суб-агентов (10 общих + 6 Obsidian + 4 MCP-scout) и контекстную систему.

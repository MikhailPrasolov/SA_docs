...
> Полное руководство по проектированию и документированию схем баз данных для системных аналитиков
...
- [`Пример БД.dbml`](./Пример%20БД.dbml) — пример схемы микросервиса пользователей
- [`Магазины_БД.dbml`](./Магазины_БД.dbml) — схема системы управления магазинами
- [`Магазины_БД_документация.md`](./Магазины_БД_документация.md) — подробная документация
...
- [Гайд MCP — Context7 для БД](../Instructions/Гайд%20MCP.md)

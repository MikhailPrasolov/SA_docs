...
| Файл | Описание |
|------|----------|
| [`Пример БД.dbml`](./Пример%20БД.dbml) | Пример схемы микросервиса пользователей (учебный) |
| [`Магазины_БД.dbml`](./Магазины_БД.dbml) | Схема системы управления сетью магазинов |
| [`Магазины_БД_документация.md`](./Магазины_БД_документация.md) | Подробная документация схемы магазинов |
| [`Alfa.dbml`](./Alfa.dbml) | Схема Alfa (добавлено) |
| [`Alfa1.dbml`](./Alfa1.dbml) | Схема Alfa1 (добавлено) |
...
- [Гайд MCP — Context7 для БД](../Instructions/Гайд%20MCP.md) — AI-агенты для БД
